...
const ListTotalSpentToFixedAccountPayableUseCase_1 = require("./ListTotalSpentToFixedAccountPayableUseCase");
let financialCategoriesRepositoryInMemory;
let listTotalSpentToFixedAccountPayableUseCase;
describe('[FinancialCategory] - List total spent by financial category to accounts payable', () => {
    ...
    beforeEach(() => {
        ...
        listTotalSpentToFixedAccountPayableUseCase =
            new ListTotalSpentToFixedAccountPayableUseCase_1.ListTotalSpentToFixedAccountPayableUseCase(financialCategoriesRepositoryInMemory);
    });
...
//# sourceMappingURL=ListTotalSpentToFixedAccountPayableUseCase.spec.js.map