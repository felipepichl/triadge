...
exports.CreateSubcategoryUseCase = void 0;
...
let CreateSubcategoryUseCase = class CreateSubcategoryUseCase {
    constructor(financialCategoriesRepository) {
        this.financialCategoriesRepository = financialCategoriesRepository;
    }
    async execute({ description, userId, parentCategoryId, }) {
        const descriptionAlreadyExists = await this.financialCategoriesRepository.findByDescriptionAndParentCategory(description, parentCategoryId);
        if (descriptionAlreadyExists) {
            throw new AppError_1.AppError('Subategory description already exists', 400);
        }
...
exports.CreateSubcategoryUseCase = CreateSubcategoryUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('FinancialCategoriesRepository')),
    __metadata("design:paramtypes", [Object])
], CreateSubcategoryUseCase);
//# sourceMappingURL=CreateSubcategoryUseCase.js.map