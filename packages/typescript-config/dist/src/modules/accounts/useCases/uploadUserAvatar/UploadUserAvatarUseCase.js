...
let UploadUserAvatarUseCase = class UploadUserAvatarUseCase {
    ...
    async execute({ userId, avatarFile }) {
        ...
        if (!user) {
            throw new AppError_1.AppError('Only authenticated can change avatar', 401);
        }
        if (user.avatar) {
...
exports.UploadUserAvatarUseCase = UploadUserAvatarUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('UsersRepository')),
    __param(1, (0, tsyringe_1.inject)('StorageProvider')),
    __metadata("design:paramtypes", [Object, Object])
], UploadUserAvatarUseCase);
//# sourceMappingURL=UploadUserAvatarUseCase.js.map