...
const FindUsersByIdsUseCase_1 = require("./FindUsersByIdsUseCase");
let usersRepositoryInMemory;
let findUsersByIdsUseCase;
describe('[Account] - Find users by ids', () => {
    beforeEach(() => {
        usersRepositoryInMemory = new UsersRepositoryInMemory_1.UsersRepositoryInMemory();
        findUsersByIdsUseCase = new FindUsersByIdsUseCase_1.FindUsersByIdsUseCase(usersRepositoryInMemory);
    });
...
//# sourceMappingURL=FindUsersByIdsUseCase.spec.js.map