...
let UpdateInterestPaidUseCase = class UpdateInterestPaidUseCase {
    ...
    async execute({ amount, accountPayableId }) {
        ...
        if (amount < accountPayable.amount) {
            throw new AppError_1.AppError('Amount cannot be less than the interest');
        }
...
exports.UpdateInterestPaidUseCase = UpdateInterestPaidUseCase;
exports.UpdateInterestPaidUseCase = UpdateInterestPaidUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('AccountsPayableRepository')),
    __metadata("design:paramtypes", [Object])
], UpdateInterestPaidUseCase);
//# sourceMappingURL=UpdateInterestPaidUseCase.js.map