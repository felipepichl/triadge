...
INSERT INTO "new_AccountPayable" ("amount", "createdAt", "description", "dueDate", "financialCategoryId", "id", "isFixed", "isPaid", "paymentDate", "transactionId", "updatedAt", "userId") SELECT "amount", "createdAt", "description", "dueDate", "financialCategoryId", "id", "isFixed", "isPaid", "paymentDate", "transactionId", "updatedAt", "userId" FROM "AccountPayable";
