/*
  ...
  - You are about to drop the column `isAmountVariable` on the `AccountPayable` table. All the data in the column will be lost.
...
INSERT INTO "new_AccountPayable" ("amount", "createdAt", "description", "dueDate", "financialCategoryId", "id", "isFixed", "isPaid", "paymentDate", "subcategoryId", "transactionId", "updatedAt", "userId") SELECT "amount", "createdAt", "description", "dueDate", "financialCategoryId", "id", "isFixed", "isPaid", "paymentDate", "subcategoryId", "transactionId", "updatedAt", "userId" FROM "AccountPayable";
